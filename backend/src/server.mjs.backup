...
async function createNotification(userId, appointmentId, type, title, message) {
  try {
...
app.post('/api/notifications/:id/cancel-appointment', authMiddleware, async (req, res) => {
